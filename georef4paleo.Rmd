...
```{r}
knitr::kable(head(raw_idb), caption = "Example of what the raw provider data look like") %>% 
...
```{r}
knitr::kable(head(processed_idb), caption = "Example of what the data look like after being processed by iDigBio") %>% 
    kable_styling(bootstrap_options = 
                         c("striped", "hover", "condensed", "responsive")) %>% 
  scroll_box(width = "100%", height = "400px")
```
...
```{r}
knitr::kable(precision, caption = "Summary of precision in georeferenced data") %>% 
    kable_styling(bootstrap_options = 
                         c("striped", "hover", "condensed", "responsive",
                           fixed_thead = TRUE)) %>% 
...
knitr::kable(geodeticDatum, caption = "Unique values present in the dwc:geodeticDatum field") %>% 
    kable_styling(bootstrap_options = 
                         c("striped", "hover", "condensed", "responsive")) %>% 
...
```{r}
knitr::kable(georeferenceProtocol, caption = "Unique values present in the dwc:georeferenceProtocol field") %>% 
    kable_styling(bootstrap_options = 
                         c("striped", "hover", "condensed", "responsive")) %>% 
  scroll_box(width = "100%", height = "200px")
...
```{r}
knitr::kable(georeferenceSources, caption = "Unique values present in the dwc:georeferenceSources field") %>% 
  kable_styling(bootstrap_options = 
                         c("striped", "hover", "condensed", "responsive")) %>% 
  scroll_box(width = "100%", height = "200px") 
```
